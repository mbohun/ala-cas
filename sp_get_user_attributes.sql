...
delimiter //
create procedure sp_get_user_attributesXXXX (p_username varchar(255))
begin
...
union select 'role' as 'key', group_concat(a.role_id) as 'value' from user_role a, users u where a.user_id=u.userid and u.username=p_username;
end
//
delimiter ;
